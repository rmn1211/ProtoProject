            ...
            <form class="flex flex-col mx-3 mb-6" method="POST" onsubmit="return validateInputs();" action="{{ url('/upload') }}">
                ...
                <div class="flex mb-4" id="matchRow">
                    ...
                    <div class="w-1/full bg-green-400 h-12">
                        ...
                        <input onload="MannschaftenH();" onfocus="javascript:MannschaftenH();$(this).autocomplete('search');" oninput="MannschaftenH()" type="text" name=" tfHome" id="tfHome" class="bg-gray-100 text-gray-900  w-full focus:outline-none border-b-full border-gray-700 border-r-2  focus:border-green-500 transition duration-500 px-3 pb-3 ={$Heimmannschaft_Prob == True}" class="bg-yellow-300 text-gray-900  w-full focus:outline-none border-b-full border-gray-700 border-r-2  focus:border-green-500 transition duration-500 px-3 pb-3 ={$Heimmannschaft_Prob == False}" value="{{ $Heim[0]->Name ?? '' }}">
                    </div>
                    <div class="w-1/full bg-green-400 h-12">
                        <label class="block text-gray-900 text-sm font-bold mb-2 ml-3" for="away">Gastverein:</label>
                        <input onload="MannschaftenG();" onfocus="javascript:MannschaftenG();$(this).autocomplete('search');" type="text" oninput="MannschaftenG()" name="tfAway" id="tfAway" class="bg-gray-100 text-gray-900  w-full focus:outlie-none border-b-full border-gray-700  border-r-2 focus:border-green-500 transition duration-500 px-3 pb-3 ={$Gastmannschaft_Prob == True}" class="bg-yellow-300 text-gray-900  w-full focus:outline-none border-b-full border-gray-700 border-r-2  focus:border-green-500 transition duration-500 px-3 pb-3 ={$Gastmannschaft_Prob == False}" value="{{ $Gast[0]->Name ?? '' }}">
                    </div>
                    <div class="w-1/full bg-green-400 h-12">
                    ...
                    <tbody class="flex-1 sm:flex-none" id="tabDoubleBody">
                        <tr class="border-solid border-b-2 border-black w-44 sm:w-auto flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0" id="doppel1">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={dualHeim_name_11_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={dualHeim_name_11_Prob == False}" name="dualVnameHeim11" id="dualVnameHeim11" value="{{ $dualHeim_name_11[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={dualHeim_name_11_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={dualHeim_name_11_Prob == False}" name="dualNnameHeim11" id="dualNnameHeim11" value="{{ $dualHeim_name_11[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualHeim_name_21_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualHeim_name_21_Prob == False}" name="dualVnameHeim21" id="dualVnameHeim21" value="{{ $dualHeim_name_21[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualHeim_name_21_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualHeim_name_11_Prob == False}" name="dualNnameHeim21" id="dualNnameHeim21" value="{{ $dualHeim_name_21[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" oninput="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualGast_name_21_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualGast_name_21_Prob == False}" name="dualVnameGast21" id="dualVnameGast21" value="{{ $dualGast_name_21[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" oninput="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualGast_name_21_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualGast_name_21_Prob == False}" name="dualNnameGast21" id="dualNnameGast21" value="{{ $dualGast_name_21[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualSatz_1_heim1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualSatz_1_heim1_Prob == False}" onchange=" changeSetSumD(1)" name="dualSatz1heim1" id="dualSatz1heim1" value="{{ $dualSatz_1_heim1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualSatz_1_gast1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualSatz_1_gast1_Prob == False}" onchange=" changeSetSumD(1)" name="dualSatz1gast1" id="dualSatz1gast1" value="{{ $dualSatz_1_gast1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualSatz_2_heim1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualSatz_2_heim1_Prob == False}" onchange="changeSetSumD(1)" name="dualSatz2heim1" id="dualSatz2heim1" value="{{ $dualSatz_2_heim1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualSatz_2_gast1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualSatz_2_gast1_Prob == False}" onchange=" changeSetSumD(1)" name="dualSatz2gast1" id="dualSatz2gast1" value="{{ $dualSatz_2_gast1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">

                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualSatz_3_heim1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualSatz_3_heim1_Prob == False}" onchange=" changeSetSumD(1)" name="dualSatz3heim1" id="dualSatz3heim1" value="{{ $dualSatz_3_heim1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={$dualSatz_3_gast1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={$dualSatz_3_gast1_Prob == False}" onchange=" changeSetSumD(1)" name="dualSatz3gast1" id="dualSatz3gast1" value="{{ $dualSatz_3_gast1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                        ...
                        <tr class="border-solid border-b-2 border-black w-44 sm:w-auto flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0" id="doppel2">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_12_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_12_Prob == False}" name="dualVnameHeim12" id="dualVnameHeim12" value="{{ $dualHeim_name_12[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_12_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_12_Prob == False}" name="dualNnameHeim12" id="dualNnameHeim12" value="{{ $dualHeim_name_12[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_22_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_22_Prob == False}" name="dualVnameHeim22" id="dualVnameHeim22" value="{{ $dualHeim_name_22[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_22_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_22_Prob == False}" name="dualNnameHeim22" id="dualNnameHeim22" value="{{ $dualHeim_name_22[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" oninput="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_12_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_12_Prob == False}" name="dualVnameGast12" id="dualVnameGast12" value="{{ $dualGast_name_12[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" oninput="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_12_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_12_Prob == False}" name="dualNnameGast12" id="dualNnameGast12" value="{{ $dualGast_name_12[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" oninput="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_22_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_22_Prob == False}" name="dualVnameGast22" id="dualVnameGast22" value="{{ $dualGast_name_22[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" oninput="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_22_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_22_Prob == False}" name="dualNnameGast22" id="dualNnameGast22" value="{{ $dualGast_name_22[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_1_heim2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_1_heim2_Prob == False}" onchange="changeSetSumD(2)" name="dualSatz1heim2" id="dualSatz1heim2" value="{{ $dualSatz_1_heim2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_1_gast2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_1_gast2_Prob == False}" onchange=" changeSetSumD(2)" name="dualSatz1gast2" id="dualSatz1gast2" value="{{ $dualSatz_1_gast2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_2_heim2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_2_heim2_Prob == False}" onchange=" changeSetSumD(2)" name="dualSatz2heim2" id="dualSatz2heim2" value="{{ $dualSatz_2_heim2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_2_gast2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_2_gast2_Prob == False}" onchange=" changeSetSumD(2)" name="dualSatz2gast2" id="dualSatz2gast2" value="{{ $dualSatz_2_gast2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_3_heim2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_3_heim2_Prob == False}" onchange="changeSetSumD(2)" name="dualSatz3heim2" id="dualSatz3heim2" value="{{ $dualSatz_3_heim2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_3_gast2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_3_gast2_Prob == False}" onchange=" changeSetSumD(2)" name="dualSatz3gast2" id="dualSatz3gast2" value="{{ $dualSatz_3_gast2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                        ...
                        <tr class="border-solid border-b-2 border-black w-44 sm:w-auto flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0" id="doppel3">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_13_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_13_Prob == False}" name="dualVnameHeim13" id="dualVnameHeim13" value="{{ $dualHeim_name_13[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_13_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_13_Prob == False}" name="dualNnameHeim13" id="dualNnameHeim13" value="{{ $dualHeim_name_13[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_23_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_23_Prob == False}" name="dualVnameHeim23" id="dualVnameHeim23" value="{{ $dualHeim_name_23[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $duaGast_name_13_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_13_Prob == False}" name="dualNnameHeim23" id="dualNnameHeim23" value="{{ $dualHeim_name_21[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" oninput="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_13_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_13_Prob == False}" name="dualVnameGast13" id="dualVnameGast13" value="{{ $dualGast_name_13[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" oninput="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_13_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_13_Prob == False}" name="dualNnameGast13" id="dualNnameGast13" value="{{ $dualGast_name_13[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" oninput="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_23_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_23_Prob == False}" name="dualVnameGast23" id="dualVnameGast23" value="{{ $dualGast_name_23[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" oninput="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_23_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_23_Prob == False}" name="dualNnameGast23" id="dualNnameGast23" value="{{ $dualGast_name_23[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_1_heim3_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_1_heim3_Prob == False}" onchange=" changeSetSumD(3)" name="dualSatz1heim3" id="dualSatz1heim3" value="{{ $dualSatz_1_heim3 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_1_gast3_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_1_gast3_Prob == False}" onchange=" changeSetSumD(3)" name="dualSatz1gast3" id="dualSatz1gast3" value="{{ $dualSatz_1_gast3 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_2_heim3_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_2_heim3_Prob == False}" onchange="changeSetSumD(3)" name="dualSatz2heim3" id="dualSatz2heim3" value="{{ $dualSatz_2_heim3 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_2_gast3_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_2_gast3_Prob == False}" onchange=" changeSetSumD(3)" name="dualSatz2gast3" id="dualSatz2gast3" value="{{ $dualSatz_2_gast3 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_3_heim3_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_3_heim3_Prob == False}" onchange=" changeSetSumD(3)" name="dualSatz3heim3" id="dualSatz3heim3" value="{{ $dualSatz_3_heim3 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_3_gast3_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_3_gast3_Prob == False}" onchange=" changeSetSumD(3)" name="dualSatz3gast3" id="dualSatz3gast3" value="{{ $dualSatz_3_gast3 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                        ...
                        <tr class="border-solid border-b-2 border-black w-44 sm:w-auto flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0" id="doppel4">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_14_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_14_Prob == False}" name="dualVnameHeim14" id="dualVnameHeim14" value="{{ $dualHeim_name_14[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_14_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_14_Prob == False}" name="dualNnameHeim14" id="dualNnameHeim14" value="{{ $dualHeim_name_14[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_24_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_24_Prob == False}" name="dualVnameHeim24" id="dualVnameHeim24" value="{{ $dualHeim_name_24[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualHeim_name_24_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualHeim_name_24_Prob == False}" name="dualNnameHeim24" id="dualNnameHeim24" value="{{ $dualHeim_name_24[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" oninput="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_14_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_14_Prob == False}" name="dualVnameGast14" id="dualVnameGast14" value="{{ $dualGast_name_14[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" oninput="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_14_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_14_Prob == False}" name="dualNnameGast14" id="dualNnameGast14" value="{{ $dualGast_name_14[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" oninput="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_24_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_24_Prob == False}" name="dualVnameGast24" id="dualVnameGast24" value="{{ $dualGast_name_24[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" oninput="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualGast_name_24_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualGast_name_24_Prob == False}" name="dualNnameGast24" id="dualNnameGast24" value="{{ $dualGast_name_24[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_1_heim4_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_1_heim4_Prob == False}" onchange=" changeSetSumD(4)" name="dualSatz1heim4" id="dualSatz1heim4" value="{{ $dualSatz_1_heim4 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_1_gast4_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_1_gast4_Prob == False}" onchange=" changeSetSumD(4)" name="dualSatz1gast4" id="dualSatz1gast4" value="{{ $dualSatz_1_gast4 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_2_heim4_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_2_heim4_Prob == False}" onchange="changeSetSumD(4)" name="dualSatz2heim4" id="dualSatz2heim4" value="{{ $dualSatz_2_heim4 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_2_gast4_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_2_gast4_Prob == False}" onchange=" changeSetSumD(4)" name="dualSatz2gast4" id="dualSatz2gast4" value="{{ $dualSatz_2_gast4 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_3_heim4_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_3_heim4_Prob == False}" onchange=" changeSetSumD(4)" name="dualSatz3heim4" id="dualSatz3heim4" value="{{ $dualSatz_3_heim4 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $dualSatz_3_gast4_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $dualSatz_3_gast4_Prob == False}" onchange=" changeSetSumD(4)" name="dualSatz3gast4" id="dualSatz3gast4" value="{{ $dualSatz_3_gast4 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                ...
                <table class="w-full flex flex-row flex-wrap rounded-lg my-5" id="tabSolo">
                    ...
                    <tbody class="flex-1 sm:flex-none" id="tabSoloBody">
                        ...
                        <tr class="border-solid border-b-2 border-black w-44 sm:w-auto flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0" id="solo1">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" oninput="VnameH(this.id)" onfocus="VnameH(this.id);javascript:$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloHeim_name_1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloHeim_name_1_Prob == False}" name="soloVnameHeim1" id="soloVnameHeim1" value="{{ $soloHeim_name_1[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" oninput="NnameH(this.id)" onfocus="NnameH(this.id);javascript:$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloHeim_name_1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloHeim_name_1_Prob == False}" name="soloNnameHeim1" id="soloNnameHeim1" value="{{ $soloHeim_name_1[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $$soloSatz_1_heim1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_1_heim1_Prob == False}" onchange=" changeSetSumS(1)" name="soloSatz1heim1" id="soloSatz1heim1" value="{{ $soloSatz_1_heim1 }}" />

                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $$soloSatz_1_gast1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_1_gast1_Prob == False}" onchange=" changeSetSumS(1)" name="soloSatz1gast1" id="soloSatz1gast1" value="{{ $soloSatz_1_gast1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $$soloSatz_2_heim1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_2_heim1_Prob == False}" onchange=" changeSetSumS(1)" name="soloSatz2heim1" id="soloSatz2heim1" value="{{ $soloSatz_2_heim1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $$soloSatz_2_gast1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_2_gast1_Prob == False}" onchange=" changeSetSumS(1)" name="soloSatz2gast1" id="soloSatz2gast1" value="{{ $soloSatz_2_gast1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $$soloSatz_3_heim1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_3_heim1_Prob == False}" onchange=" changeSetSumS(1)" name="soloSatz3heim1" id="soloSatz3heim1" value="{{ $soloSatz_3_heim1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $$soloSatz_3_gast1_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_3_gast1_Prob == False}" onchange=" changeSetSumS(1)" name="soloSatz3gast1" id="soloSatz3gast1" value="{{ $soloSatz_3_gast1 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                        ...
                        <tr class="border-solid border-b-2 border-black w-44 sm:w-auto flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0" id="solo2">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" oninput="VnameH(this.id)" size="20" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloHeim_name_2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloHeim_name_2_Prob == False}" name="soloVnameHeim2" id="soloVnameHeim2" value="{{ $soloHeim_name_2[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" oninput="NnameH(this.id)" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloHeim_name_2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloHeim_name_2_Prob == False}" name="soloNnameHeim2" id="soloNnameHeim2" value="{{ $soloHeim_name_2[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" oninput="VnameG(this.id)" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloGast_name_2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloGast_name_2_Prob == False}" name="soloVnameGast2" id="soloVnameGast2" value="{{ $soloGast_name_2[0]->Vorname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" oninput="NnameG(this.id)" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloGast_name_2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloGast_name_2_Prob == False}" name="soloNnameGast2" id="soloNnameGast2" value="{{ $soloGast_name_2[0]->Nachname ?? '' }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloSatz_1_heim2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_1_heim2_Prob == False}" onchange=" changeSetSumS(2)" name="soloSatz1heim2" id="soloSatz1heim2" value="{{ $soloSatz_1_heim2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloSatz_1_gast2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_1_gast2_Prob == False}" onchange=" changeSetSumS(2)" name="soloSatz1gast2" id="soloSatz1gast2" value="{{ $soloSatz_1_gast2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloSatz_2_heim2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_2_heim2_Prob == False}" onchange=" changeSetSumS(2)" name="soloSatz2heim2" id="soloSatz2heim2" value="{{ $soloSatz_2_heim2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloSatz_2_gast2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_2_gast2_Prob == False}" onchange=" changeSetSumS(2)" name="soloSatz2gast2" id="soloSatz2gast2" value="{{ $soloSatz_2_gast2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloSatz_3_heim2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_3_heim2_Prob == False}" onchange=" changeSetSumS(2)" name="soloSatz3heim2" id="soloSatz3heim2" value="{{ $soloSatz_3_heim2 }}" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid sm:border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 p-1.5 ={ $soloSatz_3_gast2_Prob == True}" class="bg-yellow-300 text-black w-full h-full sm:text-right focus:bg-green-400 transition duration-300 sm:p-1.5 ={ $soloSatz_3_gast2_Prob == False}" onchange=" changeSetSumS(2)" name="soloSatz3gast2" id="soloSatz3gast2" value="{{ $soloSatz_3_gast2 }}" />
                            </td>
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed sm:border-r-2 border-black">
