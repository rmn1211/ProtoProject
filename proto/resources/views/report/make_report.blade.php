            ...
            <form class="mx-3 mb-6" method="POST" onsubmit="return validateInputs();" action="{{ url('/overview') }}">
                ...
                <div class="flex mb-4" style="overflow-x:auto;" id="matchRow">
                    <div class="w-1/full bg-green-400 h-16 min-w-fit">
                        ...
                        <input onfocus="javascript:$(this).autocomplete('search');" oninput="regioncheck()" type="text" id="region" name="region" onChange="markInput(this)" class="bg-gray-100 text-gray-900 h-9 w-full border-gray-700 border-r-2 border-t-2 focus:outline-none border-b-full border-gray-700 focus:bg-green-400 transition duration-500 pl-1">

                    </div>
                    <div class="w-1/full bg-green-400 h-16 min-w-fit">
                        <label class="block text-gray-900 text-sm font-bold pb-2 border-gray-700 border-r-2 pl-1">Staffel:</label>
                        <input type="text" onfocus="javascript:$(this).autocomplete('search');" oninput="check()" id="liga" onChange="markInput(this)" name="liga" class="bg-gray-100 text-gray-900 h-9 w-full border-gray-700 border-r-2 border-t-2 focus:outline-none border-b-full border-gray-700 focus:bg-green-400 transition duration-500 pl-1">
                    </div>
                    ...
                    <div class="w-1/full bg-green-400 h-16 min-w-fit">
                        ...
                        <input type="text" name="schiri" id="schiri" onChange="markInput(this)" class="bg-gray-100 text-gray-900 border-gray-700 border-r-2 border-t-2 h-9 w-full focus:outline-none border-b-full border-gray-700 focus:bg-green-400 transition duration-500 pl-1">
                    </div>
                    <div class="w-1/full bg-green-400 h-16 min-w-fit">
                        <label class="block text-gray-900 text-sm font-bold pb-2 pl-1" for="away">Austragungsort:</label>
                        <input type="text" name="tfPlace" id="tfPlace" onChange="markInput(this)" class="bg-gray-100 text-gray-900 h-9 w-full focus:outline-none border-b-full border-gray-700 focus:bg-green-400 transition border-t-2 duration-500 pl-1">
                    </div>
                </div>
                        ...
                        <tbody class="" id="tabDoubleBody">
                            <tr class="border-solid border-b-2 border-black w-44 w-auto flex flex-col flex-no wrap table-row mb-0" id="doppel1">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-solid border-b-2 border-r-2 border-black">
                                    <input type="text" list="arten" size="4" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300" name="dualType1" id="dualType1" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameHeim11" id="dualVnameHeim11" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameHeim11" id="dualNnameHeim11" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameHeim21" id="dualVnameHeim21" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameHeim21" id="dualNnameHeim21" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameGast11" id="dualVnameGast11" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameGast11" id="dualNnameGast11" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameGast21" id="dualVnameGast21" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameGast21" id="dualNnameGast21" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 min-w-600 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(1)" name="dualSatz1heim1" id="dualSatz1heim1" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(1)" name="dualSatz1gast1" id="dualSatz1gast1" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(1)" name="dualSatz2heim1" id="dualSatz2heim1" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(1)" name="dualSatz2gast1" id="dualSatz2gast1" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(1)" name="dualSatz3heim1" id="dualSatz3heim1" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(1)" name="dualSatz3gast1" id="dualSatz3gast1" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                            ...
                            <tr class="border-solid border-b-2 border-black w-44 w-auto table-row mb-0" id="doppel2">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-solid border-b-2 border-r-2 border-black">
                                    <input type="text" list="arten" size="4" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300" name="dualType2" id="dualType2" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameHeim22" id="dualVnameHeim22" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameHeim22" id="dualNnameHeim22" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameGast22" id="dualVnameGast22" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameGast22" id="dualNnameGast22" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(2)" name="dualSatz1heim2" id="dualSatz1heim2" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(2)" name="dualSatz1gast2" id="dualSatz1gast2" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(2)" name="dualSatz2heim2" id="dualSatz2heim2" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(2)" name="dualSatz2gast2" id="dualSatz2gast2" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(2)" name="dualSatz3heim2" id="dualSatz3heim2" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(2)" name="dualSatz3gast2" id="dualSatz3gast2" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                            ...
                            <tr class="border-solid border-b-2 border-black w-44 w-auto table-row mb-0" id="doppel3">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-solid border-b-2 border-r-2 border-black">
                                    <input type="text" list="arten" size="4" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300" name="dualType3" id="dualType3" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameHeim13" id="dualVnameHeim13" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameHeim23" id="dualVnameHeim23" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameHeim23" id="dualNnameHeim23" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameGast13" id="dualVnameGast13" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameGast23" id="dualVnameGast23" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameGast23" id="dualNnameGast23" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(3)" name="dualSatz1heim3" id="dualSatz1heim3" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(3)" name="dualSatz1gast3" id="dualSatz1gast3" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(3)" name="dualSatz2heim3" id="dualSatz2heim3" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(3)" name="dualSatz2gast3" id="dualSatz2gast3" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(3)" name="dualSatz3heim3" id="dualSatz3heim3" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(3)" name="dualSatz3gast3" id="dualSatz3gast3" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                            ...
                            <tr class="border-solid border-b-2 border-black w-44 w-auto table-row mb-0" id="doppel4">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-solid border-b-2 border-r-2 border-black">
                                    <input type="text" list="arten" size="4" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300" name="dualType4" id="dualType4" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameHeim24" id="dualVnameHeim24" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameHeim24" id="dualNnameHeim24" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameGast14" id="dualVnameGast14" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                ...
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="dualVnameGast24" id="dualVnameGast24" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="dualNnameGast24" id="dualNnameGast24" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(4)" name="dualSatz1heim4" id="dualSatz1heim4" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(4)" name="dualSatz1gast4" id="dualSatz1gast4" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(4)" name="dualSatz2heim4" id="dualSatz2heim4" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(4)" name="dualSatz2gast4" id="dualSatz2gast4" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumD(4)" name="dualSatz3heim4" id="dualSatz3heim4" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                    <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumD(4)" name="dualSatz3gast4" id="dualSatz3gast4" />
                                </td>
                                <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                ...
                <table class="w-full flex flex-row flex-wrap rounded-lg my-5" id="tabSolo">
                    ...
                    <tbody class="flex-1 flex-none" id="tabSoloBody">
                        <tr class="border-solid border-b-2 border-black w-44 w-auto flex flex-col flex-no wrap table-row mb-0" id="solo1">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-solid border-b-2 border-r-2 border-black">
                                <input type="text" list="arten" size="4" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300" name="soloType1" id="soloType1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" onfocus="VnameH(this.id);javascript:$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="soloVnameHeim1" id="soloVnameHeim1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" onfocus="NnameH(this.id);javascript:$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="soloNnameHeim1" id="soloNnameHeim1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" name="soloVnameGast1" id="soloVnameGast1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" onChange="markInput(this)" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" name="soloNnameGast1" id="soloNnameGast1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumS(1)" name="soloSatz1heim1" id="soloSatz1heim1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumS(1)" name="soloSatz1gast1" id="soloSatz1gast1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumS(1)" name="soloSatz2heim1" id="soloSatz2heim1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumS(1)" name="soloSatz2gast1" id="soloSatz2gast1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumS(1)" name="soloSatz3heim1" id="soloSatz3heim1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumS(1)" name="soloSatz3gast1" id="soloSatz3gast1" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                        ...
                        <tr class="border-solid border-b-2 border-black w-44 w-auto flex flex-col flex-no wrap table-row mb-0" id="solo2">
                            ...
                            <td class="bg-gray-100 h-8 text-black border-solid border-b-2 border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300" onChange="markInput(this)" name="soloType2" id="soloType2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" onload="VnameH(this.id)" onfocus="javascript:VnameH(this.id);$(this).autocomplete('search');" size="20" size="20" class="bg-gray-100 text-black w-full h-full text-right focus:bg-green-400 transition duration-300 pr-1" onChange="markInput(this)" name="soloVnameHeim2" id="soloVnameHeim2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" onload="NnameH(this.id)" onfocus="javascript:NnameH(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onChange="markInput(this)" name="soloNnameHeim2" id="soloNnameHeim2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" onload="VnameG(this.id)" onfocus="javascript:VnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full text-right  focus:bg-green-400 transition duration-300 pr-1" onChange="markInput(this)" name="soloVnameGast2" id="soloVnameGast2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" onload="NnameG(this.id)" onfocus="javascript:NnameG(this.id);$(this).autocomplete('search');" size="20" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onChange="markInput(this)" name="soloNnameGast2" id="soloNnameGast2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-right  text-black w-full h-full focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumS(2)" name="soloSatz1heim2" id="soloSatz1heim2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumS(2)" name="soloSatz1gast2" id="soloSatz1gast2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-right text-black w-full h-full focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumS(2)" name="soloSatz2heim2" id="soloSatz2heim2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumS(2)" name="soloSatz2gast2" id="soloSatz2gast2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-right text-black w-full h-full focus:bg-green-400 transition duration-300 pr-1" onchange="markInput(this); changeSetSumS(2)" name="soloSatz3heim2" id="soloSatz3heim2" />
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-solid border-r-2 border-black">
                                <input type="text" size="4" class="bg-gray-100 text-black w-full h-full focus:bg-green-400 transition duration-300 pl-1" onchange="markInput(this); changeSetSumS(2)" name="soloSatz3gast2" id="soloSatz3gast2" />
                            </td>
                            </td>
                            <td class="bg-gray-100 h-8 text-black border-dashed border-r-2 border-black">
